 ...
 */
AsyncOutFileWriteThread::AsyncOutFileWriteThread(AsyncOutFile *aof):
    aOutFile(aof) {}

void AsyncOutFileWriteThread::operator ()()
{
...
AsyncOutFile::AsyncOutFile(const std::string &filePath):
...
void AsyncOutFile::newFile(const std::string& filePath)
{
...
void AsyncOutFile::writeBuf(char* outBuffer, int size)
{
